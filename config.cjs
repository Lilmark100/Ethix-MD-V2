...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Ethix-MD&XE32qEN9",
  ...
  AUTO_REACT: process.env.AUTO_REACT !== undefined ? process.env.AUTO_REACT === 'fasle' : false,
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Dark Wrld",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "256759329821",
